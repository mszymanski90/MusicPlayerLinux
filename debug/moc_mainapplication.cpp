...
**
** Created: Fri 18. Jul 22:45:46 2014
...
static const char qt_meta_stringdata_MainApplication[] = {
    "MainApplication\0\0loadFile()\0play()\0"
    "stop()\0"
};
...
const QMetaObjectExtraData MainApplication::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MainApplication::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MainApplication,
      qt_meta_data_MainApplication, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MainApplication::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MainApplication))
